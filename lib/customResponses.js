...
//then require to server.js

//this goes hand with the error handler. rather than writing it several times whenever an error appears, we keep it here
 //and by sending off just 'res.badRequest'
